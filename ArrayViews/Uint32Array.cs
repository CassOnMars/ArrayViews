// <copyright file="Uint32Array.cs" company="Antidecorum">
...
namespace ArrayViews
{
    ...
    /// <summary>
    /// Describes a view over a byte array as an unsigned 32-bit
    /// integer array.
    /// </summary>
    public class Uint32Array : ITypedArray<uint>
    {
        private byte[] buffer;
        ...
        public Uint32Array(byte[] buffer, int byteOffset = 0, int length = 0, bool? isLittleEndian = null)
        {
            this.buffer = buffer;
        ...
        /// <summary>
        /// Accesses the uint at the corresponding index, adjusted for offset.
        /// and length.
        /// </summary>
        /// <param name="index">The index of the typed array.</param>
        /// <returns>A uint at the provided index.</returns>
