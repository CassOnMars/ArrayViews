// <copyright file="Int8Array.cs" company="Antidecorum">
...
namespace ArrayViews
{
    ...
    /// <summary>
    /// Describes a view over a byte array as a signed byte array.
    /// </summary>
    public class Int8Array : ITypedArray<sbyte>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Int8Array"/> class.
        /// </summary>
        ...
        public Int8Array(byte[] buffer, int byteOffset = 0, int length = 0)
        {
            this.buffer = buffer;
        ...
        /// <returns>A signed byte at the provided index.</returns>
        public sbyte this[int index]
        {
            get
            {
                ...
                {
                    return (sbyte)this.buffer[this.byteOffset + index];
                }
                else
                {
            ...
            set
            {
                if (this.Length > index && index >= 0)
                {
                    this.buffer[this.byteOffset + index] = (byte)value;
                }
                else
                {
                    throw new ArgumentOutOfRangeException("index", index, "Index is outside of the range of possible values for the array.");
